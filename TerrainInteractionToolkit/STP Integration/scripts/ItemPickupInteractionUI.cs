    ...
    public sealed class ItemPickupInteractionUI : PlayerUIBehaviour, IInteractableInfoDisplayer
    {
        ...
        public void UpdateInfo(IHoverable hoverable)
        {
            ...
            if (m_IsVisible)
            {
                ...
                //m_ItemPickupBounds = m_ItemPickup.GetComponentInChildren<Renderer>().bounds; //booger
                m_ItemPickupBounds = m_ItemPickup.GetComponentInChildren<Collider>().bounds; //booger: placeholders don't have renderers.
            } 
        }
